...
optimizeBI c t "_equInt" ((_, _, ExprLiteral (LitInteger i0)):(_, _, ExprLiteral (LitInteger i1)):[]) = (c, t, ExprLiteral (LitInteger (if i0 == i1 then 1 else 0) ))
optimizeBI c t "_neqInt" ((_, _, ExprLiteral (LitInteger i0)):(_, _, ExprLiteral (LitInteger i1)):[]) = (c, t, ExprLiteral (LitInteger (if i0 /= i1 then 1 else 0) ))
optimizeBI c t "_leqInt" ((_, _, ExprLiteral (LitInteger i0)):(_, _, ExprLiteral (LitInteger i1)):[]) = (c, t, ExprLiteral (LitInteger (if i0 <= i1 then 1 else 0) ))
optimizeBI c t "_greInt" ((_, _, ExprLiteral (LitInteger i0)):(_, _, ExprLiteral (LitInteger i1)):[]) = (c, t, ExprLiteral (LitInteger (if i0 > i1 then 1 else 0) ))
...
optimizeBI c t "_equFlt" ((_, _, ExprLiteral (LitFloating f0)):(_, _, ExprLiteral (LitFloating f1)):[]) = (c, t, ExprLiteral (LitInteger (if f0 == f1 then 1 else 0) ))
optimizeBI c t "_neqFlt" ((_, _, ExprLiteral (LitFloating f0)):(_, _, ExprLiteral (LitFloating f1)):[]) = (c, t, ExprLiteral (LitInteger (if f0 /= f1 then 1 else 0) ))
optimizeBI c t "_leqFlt" ((_, _, ExprLiteral (LitFloating f0)):(_, _, ExprLiteral (LitFloating f1)):[]) = (c, t, ExprLiteral (LitInteger (if f0 <= f1 then 1 else 0) ))
optimizeBI c t "_greFlt" ((_, _, ExprLiteral (LitFloating f0)):(_, _, ExprLiteral (LitFloating f1)):[]) = (c, t, ExprLiteral (LitInteger (if f0 > f1 then 1 else 0) ))
